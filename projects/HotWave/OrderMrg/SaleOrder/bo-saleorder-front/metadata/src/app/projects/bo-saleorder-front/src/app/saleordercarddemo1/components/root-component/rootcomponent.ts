...
export class RootComponent extends FrameComponent implements OnInit, AfterViewInit, OnDestroy {
    ...
    ngOnInit() {
        ...
        this.stateMachine.stateChange.subscribe(() => {
            ...
            const states = {
                'button-add-orderdetail': !this.viewModel.stateMachine['canAddDetail'],
                'button-remove-orderdetail': !this.viewModel.stateMachine['canRemoveDetail'],
            }; 
        ...
        contents: [
            {
                ...
                visible: true,
                title: this.langService.transform("button-add-orderdetail", this.lang, "新增"),
                click: ($event) => { this.viewModel.orderdetailComponentViewmodel.orderdetailAddItem1($event); },
                appearance: {
            ...
            },
            {
                ...
                visible: true,
                title: this.langService.transform("button-remove-orderdetail", this.lang, "删除"),
                click: ($event) => { this.viewModel.orderdetailComponentViewmodel.orderdetailRemoveItem1($event); },
                appearance: {
                    "class": "btn btn-secondary f-btn-ml"
                }
            }
    ...
    SectionsectionorderdetailMainTitle = this.langService.transform("Section/section-orderdetail/mainTitle", this.lang, "订单明细");
    SectionsectionorderdetailSubTitle = this.langService.transform("Section/section-orderdetail/subTitle", this.lang, "");
    ScrollspyItemsscrollspy = [
        ...
        },
        {
            ...
            "visible": true,
            "title": this.langService.transform("Scrollspy/scrollspy/items/section-orderdetail", this.lang, "订单明细")
        }
    ];
