...
@Injectable()
export class OrderdetailComponentViewmodel extends ViewModel {
    public bindingPath = '/orderDetails';
    // farrisDataGrid列集合定义 在对应component中赋值
    public dataGrid_orderdetailColumns:any;
  ...
  "dataGrid_orderdetail": {
    ...
    public orderdetailAddItem1(commandParam?: any): Observable<any> { return; }
    ...
    public orderdetailRemoveItem1(commandParam?: any): Observable<any> { return; }
