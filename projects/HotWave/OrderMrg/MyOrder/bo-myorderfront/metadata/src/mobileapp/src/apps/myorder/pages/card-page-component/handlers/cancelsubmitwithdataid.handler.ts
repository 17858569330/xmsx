...
@CommandHandlerMeta({
    commandName: 'CancelSubmitWithDataId'
})
export class CancelSubmitWithDataIdHandler extends CommandHandler {
    constructor(
    ...
    schedule() {
        this.addTask('cancelSubmitWithDataId', (context: CommandContext) => {
            ...
            return this.invoke(this._ApproveService1, 'cancelSubmitWithDataId', args, context);
        });
