...
export class RootComponent extends FrameComponent implements OnInit, AfterViewInit, OnDestroy {
    ...
    ngOnInit() {
        ...
        const states = {
                'purchasedetailAddButton': !this.viewModel.stateMachine['canAddDetail'],
                'purchasedetailRemoveButton': !this.viewModel.stateMachine['canRemoveDetail'],
        }; 
    ...
    helpIdLookupPicked = (data) => {
        return this.viewModel.rootviewmodelbatchAppendByPathBasedOnHelpSelections1.call(this, data);
    }; 
        ...
        contents: [
            {
                ...
                visible: true,
                title: this.langService.transform("purchasedetailAddButton", this.lang, "添加补货商品"),
            ...
            },
            {
                ...
                visible: true,
                title: this.langService.transform("purchasedetailRemoveButton", this.lang, "删除"),
                click: () => { this.viewModel.purchasedetailComponentViewmodel.purchasedetailRemoveItem1(); },
                appearance: {
                    "class": "btn btn-secondary f-btn-ml"
                }
            }
    ...
    purchasedetailtabpage = this.langService.transform("purchasedetail-tab-page", this.lang, "补货采购细节");
