...
export class RootComponent extends FrameComponent implements OnInit, AfterViewInit, OnDestroy {
    ...
    ngOnInit() {
        ...
        this.stateMachine.stateChange.subscribe(() => {
            const pageHeaderToolbarToolbarItemsstates = {
                ...
                'ToolBar-cloned-lit8': !this.viewModel.stateMachine['canAdd'],
    ...
    helpIdLookupPicked = (data) => {
        return this.viewModel.rootviewmodelbatchAppend5.call(this, data);
    }; 
    pageHeaderToolbarToolbarItems = [{
        ...
        "text": this.langService.transform("ToolBar-cloned-lit8", this.lang, "批量新增"),
        ...
        "id": "button-edit",
        "text": this.langService.transform("button-edit", this.lang, "批量编辑"),
