...
@Injectable()
export class PurchasedetailComponentViewmodel extends ViewModel {
    public bindingPath = '/purchaseDetails';
    // farrisDataGrid列集合定义 在对应component中赋值
    public dataGrid_purchasedetailColumns:any;
  ...
  "dataGrid_purchasedetail": {
    ...
    public purchasedetailAddItem1(commandParam?: any): Observable<any> { return; }
    ...
    public purchasedetailRemoveItem1(commandParam?: any): Observable<any> { return; }
