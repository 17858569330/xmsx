...
import { PurchaseOrderRoutingModule } from './routing';
...
import { PurchasedetailComponent } from './components/purchasedetail-component/purchasedetailcomponent';
...
var PurchaseOrderModule = /** @class */ (function () {
    ...
    PurchaseOrderModule = tslib_1.__decorate([
        NgModule({
            exports: [
                RootComponent
            ],
