        ...
        execute: function () {
            ...
            var GoodsStockProxy = /** @class */ (function (_super) {
                ...
                function GoodsStockProxy(httpClient, uriService) {
                    ...
                    _this.apiUrl = 'api/hotwave/stock/v1.0/goodsstockpurchase_frm';
            ...
            var Save1Handler = /** @class */ (function (_super) {
                ...
                function Save1Handler(_ValidationService1, _ListDataService1, _EndEditService1, _CommandService1, _StateMachineService1) {
                    var _this = _super.call(this) || this;
            ...
            var rootviewmodelAdd1Handler = /** @class */ (function (_super) {
                __extends(rootviewmodelAdd1Handler, _super);
                ...
                rootviewmodelAdd1Handler = __decorate([
                    Injectable(),
                    NgCommandHandler({
            ...
            var RootComponent = /** @class */ (function (_super) {
                ...
                function RootComponent(wizardSer, keybindingService, langService, route, router, rootElement, localizationService, frmI18nSettingService, frameworkService, applicationParamsService, verifyService, stateMachine, sanitizer, injector) {
                    ...
                    _this.pageHeaderToolbarToolbarItems = [{
                            "id": "button-add",
                            "text": _this.langService.transform("button-add", _this.lang, "生成补货单"),
                ...
                RootComponent.prototype.pageHeaderToolbarClickHandler = function (args) {
                    switch (args.id) {
                        case 'button-add':
                            this.viewModel.rootviewmodelAdd1(args);
                            break;
                        case 'button-edit':
                ...
                RootComponent = __decorate([
                    Component({
                        ...
                        providers: [
                            ...
                            { provide: FORM_ID, useValue: "cb5d51c9-e9ca-4c4d-b5a8-4f21f7357a5f" },
                            ...
                            { provide: COMMAND_HANDLERS_TOKEN, useClass: rootviewmodelAdd1Handler, multi: true },
                        ]
                    }),
            ...
            var GoodsStockPurchaseRoutingModule = /** @class */ (function () {
                function GoodsStockPurchaseRoutingModule() {
                }
                GoodsStockPurchaseRoutingModule = __decorate([
                    NgModule({
                        imports: [
                ...
                ], GoodsStockPurchaseRoutingModule);
                return GoodsStockPurchaseRoutingModule;
            }());
            ...
            var GoodsStockPurchaseModule = /** @class */ (function () {
                function GoodsStockPurchaseModule(trans) {
                    this.trans = trans;
                }
                GoodsStockPurchaseModule = __decorate([
                    NgModule({
                        exports: [
                            RootComponent
                        ],
                        ...
                        providers: [
                            ...
                            FrmI18nSettingService,
                            FileViewerService,
                            { provide: FORM_PATH_TOKEN, useValue: '/apps/hotwave/stock/web/bo-goodsstock-front/goodsstockpurchase/' },
                            { provide: BE_SERVER_URI_TOKEN, useFactory: ɵ2$1 }
                        ]
                    }),
                    __metadata("design:paramtypes", [TranslateResolveService])
                ], GoodsStockPurchaseModule);
                return GoodsStockPurchaseModule;
            }());
            function createTranslateLoader$1(http) {
                return new TranslateHttpLoader(http, '/apps/hotwave/stock/web/bo-goodsstock-front/goodsstockpurchase/i18n/', '.json');
            }
