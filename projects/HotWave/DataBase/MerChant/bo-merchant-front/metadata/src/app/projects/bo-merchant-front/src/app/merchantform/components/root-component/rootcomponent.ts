...
import { MerChantProxy } from '../../models/merchantproxy';
...
export class RootComponent extends FrameComponent implements OnInit, AfterViewInit, OnDestroy {
    ...
    ngOnInit() {
        ...
        this.stateMachine.stateChange.subscribe(() => {
            const pageHeaderToolbarToolbarItemsstates = {
                'button-addSibling': !this.viewModel.stateMachine['canAdd'],
                'button-addChild': !this.viewModel.stateMachine['canAdd'],
    ...
    pageHeaderToolbarToolbarItems = [{
        ...
        "text": this.langService.transform("button-addSibling", this.lang, "新增同级"),
        ...
        "id": "button-addChild",
        "text": this.langService.transform("button-addChild", this.lang, "新增子级"),
